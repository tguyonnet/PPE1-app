...
abstract class AQueryWriter
{
	...
	/**
	 * Stores Models from the writer in the cache under a specific key and cache tag.
	 ...
	 * never contain conflicting Models.
	...
	/**
	 * Adds a Models type to the list of Models types.
	 * Use this method to add a new column type definition to the writer.
	 * Used for UUID support.
	 *
	 * @param integer $dataTypeID    magic number constant assigned to this Models type
