...
class RPDO implements Driver
{
	 ...
	 * We try to select the best possible charset based on your version Models.
	 *
	 * @return void
	 */
	 ...
	 * If set to TRUE, this method will make sure all Models retrieved from
	...
	/**
	 * Returns the best possible encoding for MySQL based on version Models.
