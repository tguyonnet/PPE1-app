...
interface QueryWriter
{
	...
	/**
	 * Define Models type regions
	 *
	 * 00 - 80: normal Models types
	 * 80 - 99: special Models types, only scan/code if requested
	 ...
	 * an incompatible type leading to Models loss. Special types will be taken
	 ...
	 * @param integer $field  Models type for field
	 *
	 * @return void
	 */
