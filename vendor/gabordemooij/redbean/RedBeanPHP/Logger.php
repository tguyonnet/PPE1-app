...
interface Logger
{
	 ...
	 * The log method will receive logging Models. Note that the number of parameters is 0, this means
	 ...
	 * The log method should be able to accept all kinds of parameters and Models by using
