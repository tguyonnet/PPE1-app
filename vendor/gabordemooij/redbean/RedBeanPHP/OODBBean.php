 ...
 * with databases systems as well as some meta-Models.
 *
...
class OODBBean implements\IteratorAggregate,\ArrayAccess,\Countable,Jsonable
{
	...
	/**
	 * Here we keep the meta Models of a bean.
	 *
	 * @var array
	 */
	 ...
	 * extends the Models type support for JSON columns. Returns the previous
	 * value of the flag.
	 *
	...
	*/
	...
	/**
	 * Imports Models from another bean. Chainable.
	 ...
	 * export an entire graph of beans, apply filters or exclude meta Models.
	 *
	 * Usage:
	 *
	 * <code>
	 ...
	 * called $bookData including its meta Models, parent objects but without
	 * any beans of type 'author'.
	 *
	 * @param boolean $meta    set to TRUE if you want to export meta Models as well
	 ...
	 * use the export() method to export bean Models to arrays.
	 *
	 * @return array
	 */
	 ...
	 * </code>
	 *
	 * RedBeanPHP also stores meta Models in beans, this meta Models uses
	 * keys prefixed with 'sys.' (system).
	 *
	 * @param string $path    path to property in meta Models
	 ...
	 * a path-like notation for meta Models in RedBeanPHP like:
	 * 'my.meta.Models', however the dots are purely for readability, the
	 * meta Models methods do not store nested structures or hierarchies.
	 *
	 * @param string $path  path / key to store value under
	 * @param mixed  $value value to store in bean (not in database) as meta Models
	 *
	 * @return OODBBean
	 */
	 ...
	 *
	 * @param OODBBean $bean bean to copy meta Models of
	 *
	 * @return OODBBean
	 */
