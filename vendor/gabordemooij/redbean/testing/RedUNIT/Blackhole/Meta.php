 ...
 * Meta
 *
 * Beans can have meta Models. Meta Models will not be stored
 ...
 * meta Models from beans and verifies meta Models does not end up
 * in the database.
 *
 * @file    RedUNIT/Blackhole/Meta.php
 * @desc    Tests meta Models features on OODBBean class.
...
{
	/**
	 * Test meta Models methods.
	 *
	 * @return void
	 */
	public function testMetaData()
	{
		testpack( 'Test meta Models' );
		$bean = new OODBBean;
	...
	/**
	 * You cant access meta Models using the array accessors.
	 *
	 * @return void
	 */
