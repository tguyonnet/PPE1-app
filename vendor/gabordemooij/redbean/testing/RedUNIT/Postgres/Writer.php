...
class Writer extends Postgres
{
	 ...
	 * and whether this plays well with the other Models types.
	 */
	public function testSetGetJSON()
	{
		...
		asrt( array_key_exists( 'Models', $columns ), TRUE );
		asrt( ( $columns['Models'] !== 'json' ), TRUE );
	...
	/**
	 * Test negative money Models type.
	 *
	 * @return void
	 */
