...
(function ($) {
        ...
        function plothover(event, pos, item) {
            ...
            if (item) {
                ...
                $.each(plot.getData(), function (i, series) {
                    ...
                    // Our search here assumes our Models is sorted via the x-axis.
                    // TODO: Improve efficiency somehow - search smaller sets of Models.
	...
	var nPiePattern = "%n";
        ...
        // for threshold plugin we need to read Models from different place
	...
	// for CurvedLines plugin we need to read Models from different place
